...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.i(TAG, "Service created aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i(TAG, "Service destroyed aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    }
